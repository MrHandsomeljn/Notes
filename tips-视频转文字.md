...
1. 将视频导入剪映
2. 左边【文本】-【智能字幕】-【开始识别】
3. 识别完成之后关闭剪映，打开项目路径（我的是 ``C:\Users\***\AppData\Local\JianyingPro\User Data\Projects\com.lveditor.draft``），按创建时间找到当前项目文件夹
...
5. 内容粘贴到本目录下./files/Codes/jianying2txtInput.txt
6. 运行[python脚本](./files/Codes/jianying2txt.py)

方法2

5. 将``draft_content.json``拖放到[python脚本](./files/Codes/jianying2txt.py)上
